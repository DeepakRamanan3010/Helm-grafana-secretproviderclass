...
*/}}
{{- define "aws.secretProviderClass.fullname" -}}
{{- if .Values.secretProviderClass.fullnameOverride }}
{{- .Values.secretProviderClass.fullnameOverride | trunc 63 | trimSuffix "-" }}
{{- else }}
{{- $name := default .Chart.Name .Values.nameOverride }}
{{- if contains $name .Release.Name }}
{{- printf "%s-%s" .Release.Name "aws-secrets" | trunc 63 | trimSuffix "-" }}
{{- else }}
{{- printf "%s-%s-%s" .Release.Name $name "aws-secrets" | trunc 63 | trimSuffix "-" }}
{{- end }}
{{- end }}
{{- end }}
